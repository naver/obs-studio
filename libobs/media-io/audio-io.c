...
static void *audio_thread(void *param)
{
	...
	blog(LOG_INFO, "%p-%s(%s): [Enter]", audio, __FUNCTION__, audio->info.name ? audio->info.name : "null");
...
{
	//PRISM/WuLongyue/20231122/#2212/add logs
	blog(LOG_INFO, "%p-%s: [Enter] mi=%zu, callback=%p, param=%p", audio, __FUNCTION__, mi, callback, param);
	...
	//PRISM/WuLongyue/20231122/#2212/add logs
	blog(LOG_INFO, "%p-%s: [Exit] success=%d", audio, __FUNCTION__, success);
...
{
	//PRISM/WuLongyue/20231122/#2212/add logs
	blog(LOG_INFO, "%p-%s: [Enter] mi=%zu, callback=%p, param=%p", audio, __FUNCTION__, mix_idx, callback, param);
