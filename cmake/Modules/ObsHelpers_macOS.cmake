...
function(setup_target_browser target)
  ...
  install(
    ...
    COMPONENT obs_browser_dev
    EXCLUDE_FROM_ALL)
  #set(CEF_PRISM_HELPER_TARGET_PREFIX "prism-browser-helper")
  #set(CEF_LAUNCHER_HELPER_TARGET_PREFIX "launcher-browser-helper")
  foreach(_SUFFIX IN ITEMS "prism-browser-helper_gpu" 
                           "prism-browser-helper_plugin"
                           "prism-browser-helper_renderer"
                           "prism-browser-helper")
    if(TARGET OBS::${_SUFFIX})
      add_dependencies(${target} OBS::${_SUFFIX})

      install(
        DIRECTORY "$<TARGET_BUNDLE_DIR:OBS::${_SUFFIX}>"
        DESTINATION "Frameworks"
        USE_SOURCE_PERMISSIONS
        COMPONENT obs_browser_dev
        EXCLUDE_FROM_ALL)
