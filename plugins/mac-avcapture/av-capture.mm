...
static const char *av_capture_getname_lens_mobile(void *)
{
...
static bool init_format(av_capture *capture, AVCaptureDevice *dev)
{
    ...
    //PRISM/ZhongLing/20230724/#/PPRISM Lens alpha channel
...
static obs_properties_t *av_capture_properties(void *data)
{
	...
	obs_property_t *dev_list = obs_properties_add_list(
		props, "device", isMobile || isLens ? TEXT_PRISM_LENS_DEVICE : TEXT_DEVICE,
...
//		obs_property_list_add_string(dev_list, "", "");
	...
	//PRISM/Zhongling/20230828/#/lens and mobile properties
	if (isLens || isMobile) {
