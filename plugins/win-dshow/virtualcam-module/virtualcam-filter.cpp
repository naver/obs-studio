...
//PRISM/WuLongyue/20231129/none/Add PRISM VirtualCamera
	...
	const wchar_t *obs_process = L"PRISMLiveStudio.exe";
#else
	//const wchar_t *obs_process = L"obs32.exe";
	const wchar_t *obs_process = L"PRISMLiveStudio32.exe";
#endif
	...
	if (vq) {
		...
		StringCbCat(res_file, sizeof(res_file), L"\\obs-virtualcam-for-prism.txt");
