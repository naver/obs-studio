...
static bool check_dal_plugin()
{
	...
	NSString *dalPluginFileName =
		@"/Library/CoreMediaIO/Plug-Ins/DAL/prism-mac-virtualcam.plugin";
		...
		NSDictionary *dalPluginInfoPlist = [NSDictionary
			dictionaryWithContentsOfURL:
				[NSURL fileURLWithPath:
						@"/Library/CoreMediaIO/Plug-Ins/DAL/prism-mac-virtualcam.plugin/Contents/Info.plist"]];
	...
	if (!dalPluginInstalled || dalPluginUpdateNeeded) {
		...
		NSString *pluginPath =
			@"Contents/Resources/prism-mac-virtualcam.plugin";
